...
<body>
  ...
  <table border="1">
   ...
   <p>
    ...
    &nbsp&nbsp<xsl:value-of select="/ReportFastqScreen/Report/ReadsMapped/@name"/>  
     / 
    <xsl:value-of select="format-number(/ReportFastqScreen/Report/ReadsProcessed,'# ##0','thousand')"/>&nbsp&nbsp

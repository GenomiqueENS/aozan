...
public class TestCollectorReadBinary {
  ...
  public void testCollectorAllRun() {
    ...
    collectRun(new File(DIR_TMP + "/hiseq_log_130522_SNL110_0069_AH0HU9ADXX/"));
    collectRun(new File(DIR_TMP + "/hiseq_log_130926_SNL110_0085_AH0EYHADXX/"));
  }
  ...
  private void compareRunData(final RunData ori, final RunData test,
    ...
    test.createRunDataFile(FileUtils
        .createTempFile("Interop_" + runId, ".data"));
  }

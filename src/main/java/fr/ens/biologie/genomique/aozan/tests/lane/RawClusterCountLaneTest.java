 ...
 */
public class RawClusterCountLaneTest extends AbstractSimpleLaneTest {
   ...
   * Public constructor.
   */
  public RawClusterCountLaneTest() {

    super("lane.raw.cluster.count", "Raw Cluster Est.", "Raw Cluster Est.");
  }

...
public class MaxPFClusterCountProjectTest extends AbstractSimpleProjectTest {
  ...
  protected String getKey(final int projectId) {
    ...
    return COLLECTOR_PREFIX + ".project" + projectId + ".pf.cluster.max";
  }
   ...
   * Public constructor.
   */
  public MaxPFClusterCountProjectTest() {

    super("project.max.pf.cluster.count", "Max. PF Cluster", "Max. PF Cluster");
  }
}

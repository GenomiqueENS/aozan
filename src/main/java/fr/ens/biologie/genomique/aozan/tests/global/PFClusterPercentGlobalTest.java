 ...
 */
public class PFClusterPercentGlobalTest extends AbstractSimpleGlobalTest {
   ...
   * Public constructor.
   */
  public PFClusterPercentGlobalTest() {

    super("global.pf.cluster.percent", "PF Cluster Est.", "PF Cluster Est.",
        "%");
  }

 ...
 */
public class FastQCBadTilesSampleTest extends AbstractFastQCSampleTest {
   ...
   * Public constructor.
   */
  public FastQCBadTilesSampleTest() {

    super("sample.fastqc.bad.tiles", "Bad Tiles", "Bad Tiles");
  }

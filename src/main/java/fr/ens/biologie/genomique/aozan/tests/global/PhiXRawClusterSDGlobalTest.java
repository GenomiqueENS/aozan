...
/**
 * This class define a raw cluster phix standard deviation global test.
 * @since 1.3
 * @author Sandrine Perrin
 */
public class PhiXRawClusterSDGlobalTest extends AbstractSimpleGlobalTest {
  ...
  protected String getKey() {
    ...
    return "globalstats.clusters.raw.phix.sd";
  }
   ...
   * Public constructor.
   */
  public PhiXRawClusterSDGlobalTest() {

    super("global.phix.raw.cluster.sd", "PhiX Raw Cluster SD Est.",
        "PhiX Raw Cluster SD Est.");
  }

 ...
 */
public class RawClusterCountGlobalTest extends AbstractSimpleGlobalTest {
   ...
   * Public constructor.
   */
  public RawClusterCountGlobalTest() {

    super("global.raw.cluster.count", "Raw Cluster Est.", "Raw Cluster Est.");
  }

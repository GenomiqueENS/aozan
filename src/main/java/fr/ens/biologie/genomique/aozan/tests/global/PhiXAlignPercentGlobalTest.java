 ...
 */
public class PhiXAlignPercentGlobalTest extends AbstractSimpleGlobalTest {
   ...
   * Public constructor.
   */
  public PhiXAlignPercentGlobalTest() {

    super("global.phix.align.percent", "PhiX Aligned Est.", "PhiX Aligned Est.",
        "%");
  }

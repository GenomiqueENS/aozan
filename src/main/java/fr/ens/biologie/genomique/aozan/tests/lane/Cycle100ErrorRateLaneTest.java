 ...
 */
public class Cycle100ErrorRateLaneTest extends AbstractSimpleLaneTest {
  ...
  protected String getKey(int read, boolean indexedRead, int lane) {
    ...
    return READ_DATA_PREFIX + ".read" + read + ".lane" + lane + ".err.rate.100";
  }
   ...
   * Public constructor.
   */
  public Cycle100ErrorRateLaneTest() {

    super("lane.100.cycle.error.rate", "Error Rate 100 Cycle",

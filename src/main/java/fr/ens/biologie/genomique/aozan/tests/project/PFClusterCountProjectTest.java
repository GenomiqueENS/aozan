 ...
 * @since 1.4
 */
public class PFClusterCountProjectTest extends AbstractSimpleProjectTest {
   ...
   * Public constructor.
   */
  public PFClusterCountProjectTest() {

    super("project.pf.cluster.count", "PF Cluster", "PF Cluster");
  }

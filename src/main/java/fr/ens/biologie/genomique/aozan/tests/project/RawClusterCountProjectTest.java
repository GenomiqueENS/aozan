 ...
 * @since 1.4
 */
public class RawClusterCountProjectTest extends AbstractSimpleProjectTest {
  ...
  protected String getKey(final int projectId) {
    ...
    return COLLECTOR_PREFIX + ".project" + projectId + ".raw.cluster.sum";
  }
   ...
   * Public constructor.
   */
  public RawClusterCountProjectTest() {

    super("project.raw.cluster.count", "Raw Cluster", "Raw Cluster");
  }

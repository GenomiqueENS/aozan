 ...
 */
public class PFClusterCountSampleTest extends AbstractSimpleSampleTest {
   ...
   * Public constructor.
   */
  public PFClusterCountSampleTest() {

    super("sample.pf.cluster.count", "PF Cluster", "PF Cluster");
  }

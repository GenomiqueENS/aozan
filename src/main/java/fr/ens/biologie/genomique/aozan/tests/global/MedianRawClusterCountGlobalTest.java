 ...
 */
public class MedianRawClusterCountGlobalTest extends AbstractSimpleGlobalTest {
   ...
   * Public constructor.
   */
  public MedianRawClusterCountGlobalTest() {

    super("global.median.raw.cluster.count", "Median Raw Cluster Est.",
        "Median Raw Cluster Est.");
  }

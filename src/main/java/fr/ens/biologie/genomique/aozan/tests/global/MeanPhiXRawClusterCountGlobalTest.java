 ...
 */
public class MeanPhiXRawClusterCountGlobalTest
   ...
   * Public constructor.
   */
  public MeanPhiXRawClusterCountGlobalTest() {

    super("global.mean.phix.raw.cluster.count", "Mean PhiX Raw Cluster Est.",
        "Mean PhiX Raw Cluster Est.");
  }

 ...
 * @since 1.4
 */
public class MaxRawClusterCountPooledSampleTest
  ...
  protected String getKey(final int pooledSampleId) {
    ...
    return COLLECTOR_PREFIX
        + ".pooledsample" + pooledSampleId + ".raw.cluster.max";
  }
   ...
   * Public constructor.
   */
  public MaxRawClusterCountPooledSampleTest() {

    super("pooledsample.max.raw.cluster.count", "Max. Raw Cluster",
        "Max. Raw Cluster");
  }

 ...
 * @since 1.4
 */
public class PFClusterCountPooledSampleTest extends AbstractSimpleSampleTest {
  ...
  protected String getKey(final int pooledSampleId) {
    ...
    return COLLECTOR_PREFIX
        + ".pooledsample" + pooledSampleId + ".pf.cluster.sum";
  }
   ...
   * Public constructor.
   */
  public PFClusterCountPooledSampleTest() {

    super("pooledsample.pf.cluster.count", "PF Cluster", "PF Cluster");
  }

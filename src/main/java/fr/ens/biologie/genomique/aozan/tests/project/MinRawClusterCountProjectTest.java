 ...
 * @since 1.4
 */
public class MinRawClusterCountProjectTest extends AbstractSimpleProjectTest {
  ...
  protected String getKey(final int projectId) {
    ...
    return COLLECTOR_PREFIX + ".project" + projectId + ".raw.cluster.min";
  }
   ...
   * Public constructor.
   */
  public MinRawClusterCountProjectTest() {

    super("project.min.raw.cluster.count", "Min. Raw Cluster",
        "Min. Raw Cluster");
  }

...
/**
 * This class define a raw cluster mean global test.
 * @since 1.3
 * @author Sandrine Perrin
 */
public class MeanPFClusterCountGlobalTest extends AbstractSimpleGlobalTest {
  ...
  protected String getKey() {
    ...
    return "globalstats.clusters.pf.mean";
  }
   ...
   * Public constructor.
   */
  public MeanPFClusterCountGlobalTest() {

    super("global.mean.pf.cluster.count", "Mean PF Cluster Est.",
        "Mean PF Cluster Est.");
  }

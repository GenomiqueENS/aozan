 ...
 * @since 1.4
 */
public class RawClusterCountPooledSampleTest extends AbstractSimpleSampleTest {
   ...
   * Public constructor.
   */
  public RawClusterCountPooledSampleTest() {
    super("pooledsample.raw.cluster.count", "Raw Cluster", "Raw Cluster");
  }

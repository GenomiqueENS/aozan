 ...
 */
public class Cycle20IntensityPercentLaneTest extends AbstractSimpleLaneTest {
   ...
   * Public constructor.
   */
  public Cycle20IntensityPercentLaneTest() {

    super("lane.cycle.20.intensity.percent", "Cycle 20 Intensity",
        "Cycle 20 Intensity", "%");
  }

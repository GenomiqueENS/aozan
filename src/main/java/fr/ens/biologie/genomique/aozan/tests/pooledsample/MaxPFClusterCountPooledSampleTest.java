 ...
 * @since 1.4
 */
public class MaxPFClusterCountPooledSampleTest
  ...
  protected String getKey(final int pooledSampleId) {
    ...
    return COLLECTOR_PREFIX
        + ".pooledsample" + pooledSampleId + ".pf.cluster.max";
  }
   ...
   * Public constructor.
   */
  public MaxPFClusterCountPooledSampleTest() {

    super("pooledsample.max.pf.cluster.count", "Max. PF Cluster",
        "Max. PF Cluster");
  }
}

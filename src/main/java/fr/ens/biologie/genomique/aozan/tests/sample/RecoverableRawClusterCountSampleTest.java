 ...
 */
public class RecoverableRawClusterCountSampleTest
   ...
   * Public constructor.
   */
  public RecoverableRawClusterCountSampleTest() {

    super("sample.recoverable.raw.cluster.count", "Recoverable Raw Cluster",

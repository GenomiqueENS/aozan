...
public class PhiXRawClusterCountGlobalTest extends AbstractSimpleGlobalTest {
  ...
  protected String getKey() {
    ...
    return "globalstats.clusters.raw.phix.count";
  }
   ...
   * Public constructor.
   */
  public PhiXRawClusterCountGlobalTest() {

    super("global.phix.raw.cluster.count", "PhiX Raw Cluster Est.",
        "PhiX Raw Cluster Est.");
  }

 ...
 */
public class FastQCPerSequenceGCContentSampleTest
   ...
   * Public constructor.
   */
  public FastQCPerSequenceGCContentSampleTest() {

    super("sample.fastqc.per.sequence.gc.content", "Per Sequence GC Content",

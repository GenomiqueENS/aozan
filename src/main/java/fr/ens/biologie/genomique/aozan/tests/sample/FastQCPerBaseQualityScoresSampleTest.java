 ...
 */
public class FastQCPerBaseQualityScoresSampleTest
   ...
   * Public constructor.
   */
  public FastQCPerBaseQualityScoresSampleTest() {

    super("sample.fastqc.per.base.quality.scores", "Per Base Quality Scores",

 ...
 */
public class RawClusterCountSampleTest extends AbstractSimpleSampleTest {
   ...
   * Public constructor.
   */
  public RawClusterCountSampleTest() {

    super("sample.raw.cluster.count", "Raw Cluster", "Raw Cluster");
  }

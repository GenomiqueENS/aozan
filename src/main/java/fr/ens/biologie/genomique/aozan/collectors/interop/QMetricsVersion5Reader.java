 ...
 * QMetricsOut.bin in its version 5.
 * @author Cyril Firmo
 * @since 2.0
 */
public class QMetricsVersion5Reader extends QMetricsVersion4Reader {
  ...
  QMetricsVersion5Reader(final File dirPath) throws AozanException {

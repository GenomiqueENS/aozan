 ...
 * @since 1.4
 */
public class MaxRawClusterCountProjectTest extends AbstractSimpleProjectTest {
  ...
  protected String getKey(final int projectId) {
    ...
    return COLLECTOR_PREFIX + ".project" + projectId + ".raw.cluster.max";
  }
   ...
   * Public constructor.
   */
  public MaxRawClusterCountProjectTest() {

    super("project.max.raw.cluster.count", "Max. Raw Cluster",
        "Max. Raw Cluster");
  }

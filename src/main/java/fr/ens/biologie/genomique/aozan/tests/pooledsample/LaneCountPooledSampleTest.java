 ...
 * @since 2.4
 */
public class LaneCountPooledSampleTest extends AbstractSimpleSampleTest {
   ...
   * Public constructor.
   */
  public LaneCountPooledSampleTest() {

    super("pooledsample.lane.count", "Lane Count", "Lane Count");
  }

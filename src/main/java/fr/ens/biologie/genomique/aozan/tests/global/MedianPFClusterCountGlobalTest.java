 ...
 */
public class MedianPFClusterCountGlobalTest extends AbstractSimpleGlobalTest {
  ...
  protected String getKey() {
    ...
    return "globalstats.clusters.pf.mediane";
  }
   ...
   * Public constructor.
   */
  public MedianPFClusterCountGlobalTest() {

    super("global.median.pf.cluster.count", "Median PF Cluster Est.",
        "Median PF Cluster Est.");
  }

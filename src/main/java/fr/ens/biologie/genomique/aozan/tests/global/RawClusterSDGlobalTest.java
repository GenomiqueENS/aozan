 ...
 */
public class RawClusterSDGlobalTest extends AbstractSimpleGlobalTest {
  ...
  protected String getKey() {
    ...
    return "globalstats.clusters.raw.sd";
  }
   ...
   * Public constructor.
   */
  public RawClusterSDGlobalTest() {

    super("global.raw.cluster.sd", "Raw Cluster SD Est.",
        "Raw Cluster SD Est.");
  }

 ...
 */
public class FastQCAdapterContentSampleTest extends AbstractFastQCSampleTest {
   ...
   * Public constructor.
   */
  public FastQCAdapterContentSampleTest() {

    super("sample.fastqc.adapter.content", "Adapter Content",
        "Adapter Content");
  }

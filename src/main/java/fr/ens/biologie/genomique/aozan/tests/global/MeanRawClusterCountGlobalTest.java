 ...
 */
public class MeanRawClusterCountGlobalTest extends AbstractSimpleGlobalTest {
  ...
  protected String getKey() {
    ...
    return "globalstats.clusters.raw.mean";
  }
   ...
   * Public constructor.
   */
  public MeanRawClusterCountGlobalTest() {

    super("global.mean.raw.cluster.count", "Mean Raw Cluster Est.",
        "Mean Raw Cluster Est.");
  }
}

 ...
 */
public class FastQCSequenceLengthDistributionSampleTest
   ...
   * Public constructor.
   */
  public FastQCSequenceLengthDistributionSampleTest() {

    super("sample.fastqc.sequence.length.distribution",
